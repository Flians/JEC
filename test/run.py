...
def benchmarks(exePath, root='./', output='./output/'):
    ...
    for i, file in enumerate(files):
        names = file.split('.')
        if file.endswith('.bench') and names[0]!='c17' and names[0]!='c2670' or names[0]=='adder' or names[0]=='bar' or names[0]=='decoder' or names[0]!='divisor' or names[0]=='one_bit_full_adder' :
